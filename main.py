...
fromSpanishRadio = Radiobutton(root, text = 'Spaniola', variable = fromLanguage, indicator = 3, value = "su", font = ("Arial", 11))
...
toSpanishRadio = Radiobutton(root, text = 'Spaniola', variable = toLanguage, indicator = 3, value = "su", font = ("Arial", 11))
